================================================================================
MICROSOFT 基础类库: opencv 项目概述
===============================================================================

应用程序向导已为您创建了这个 opencv 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 opencv 应用程序的每个文件的内容。
...
opencv.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CopencvApp 应用程序类。

opencv.cpp
这是包含应用程序类 CopencvApp 的主要应用程序源文件。

opencv.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\opencv.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 opencv.rc 中。
...
opencvDlg.h，opencvDlg.cpp - 对话框
这些文件包含 CopencvDlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 opencv.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
